...
{
public:
	virtual uint32_t GetVertexBufferName(uint32_t gdVertexFormat) = 0;
	virtual uint32_t VertexBufferType(uint32_t) = 0;
	virtual uint32_t MaxVertices(uint32_t) = 0;
	virtual void* GetVertices(uint32_t, uint32_t) = 0;
	virtual void* ContinueVertices(uint32_t, uint32_t) = 0;
	virtual void ReleaseVertices(uint32_t) = 0;
	virtual void DrawPrims(uint32_t, uint32_t gdPrimType) = 0;
